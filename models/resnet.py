...
class ComplexBasicBlock(nn.Module):
    ...
    def __init__(
        ...
        if norm_layer is None:
            norm_layer = complex_modules.NaiveComplexBatchNorm2d
...
class ComplexBottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.relu = complex_activation_function.real_imaginary_relu
        self.downsample = downsample
        self.stride = stride
...
class ComplexResNet(nn.Module):
    def __init__(
        ...
        self.relu = complex_modules.ComplexReLU()
        self.maxpool = complex_modules.ComplexMaxPool2d(
        ...
        self.avgpool = complex_modules.ComplexAdaptiveAvgPool2d((1, 1))
        self.classifier = nn.Linear(512 * block.expansion, num_classes).to(
            torch.complex64
        )
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        # for complex valued CrossEntropy (LogLoss + NLL)
...
def resnet18(pretrained=False, **kwargs):
    ...
    model = ComplexResNet(block=ComplexBasicBlock, layers=[2, 2, 2, 2], **kwargs)
...
def resnet50(pretrained=False, **kwargs):
    ...
    model = ComplexResNet(block=ComplexBottleneck, layers=[3, 4, 6, 3], **kwargs)
